...
class MultipleChoiceTestScreenState extends State<MultipleChoiceTestScreen> {
  ...
  void updateProgress() {
    debugPrint(currStep.toString());
    debugPrint(questionQuantity.toString());
    setState(() {
  ...
  List<PieChartSectionData> showingSections() {
    return List.generate(2, (index) {
      ...
      double rightVal = (rightAns / answerCount.toDouble()) * 360;
      double wrongVal = (wrongAns / answerCount.toDouble()) * 360;
      switch (index) {
        case 0:
